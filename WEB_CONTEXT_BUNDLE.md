...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-110b5805a192d6be"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Graph theory, Miscellaneous graph theory; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-110b5805a192d6be",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-110b5805a192d6be",
        "url": "https://en.wikipedia.org/wiki/Bondage_number"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Teschner's bondage number conjecture: is the bondage number of a graph always less than or equal to 3/2 times its maximum degree ?",
      "version": 1
    },
    "title": "bondage number",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "ae321ecf22ea1a08f6d1bcec2597e9dc6edb9322c4c9b0347a1f92a61a8ad356"
}
```
